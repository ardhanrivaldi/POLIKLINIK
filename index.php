...
<head>
    ...
    <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/poliklinikbk/dist/css/welcome_styles.css">
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #9FA6B2;">
    <div class="container px-5">
        <a class="navbar-brand text-white fw-bold" href="index.php">Poliklinik Udinus</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="index.php">
                        <i class="bi bi-house-door"></i> <!-- Bootstrap Icons house icon -->
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-8 text-center">
                <h1 class="display-4 text-white fw-bold mb-3">Selamat datang di Poliklinik Udinus</h1>
                <p class="lead text-white-50 mb-4">Sistem Temu Janji Pasien - Dokter untuk kenyamanan Anda.</p>
                <a href="index.php?page=loginPasien" class="btn btn-primary btn-lg">DAFTAR SEKARANG</a>
            </div>
        </div>
    </div>
</header>
            ...
            <div class="col-lg-6 mb-5 mb-lg-0 d-flex justify-content-center">
                <div class="feature-card-container border-bottom border-dark">
                    <div class="card h-100">
                        <div class="card-body p-4">
                            <div class="feature bg-primary bg-secondary text-white rounded-3 mb-3"><i class="bi bi-person"></i></div>
                            <h2 class="h4 fw-bolder">Sebagai Dokter</h2>
                            <p>Apabila Anda adalah seorang Dokter, silahkan Login terlebih dahulu untuk memulai melayani Pasien!</p>
                            <a href="index.php?page=loginDokter" class="btn btn-primary btn-lg">
                                LOGIN
                                <i class="bi bi-arrow-right-circle"></i>
                            </a>
                        </div>
